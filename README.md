...
| `container-image-tags`           | Checks whether a local container image tag still matches its remote registry digest, then optionally finds every other remote tag pointing to that digest                                                            |
